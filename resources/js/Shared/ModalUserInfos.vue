<template>
    ...
    <div v-if="this.$page.props.auth == null" class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <form @submit.prevent="submit" class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div class="mt-2">
                                <!-- <p class="text-sm text-gray-500"> -->
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="email" v-model="form.email" class="border border-gray-400 p-2 w-full" name="email" id="email" required>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="submit" class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500" :disabled="form.processing">Envoyer</button>
                </div>
            </form>
        </div>
    </div>
